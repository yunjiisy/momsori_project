        ...
        Column(
          ...
          children: [
            Padding(
              padding: const EdgeInsets.only(left: 10.0),
              child: Text(
                '2. 엄마,아빠의 목소리 & 사물의 소리를 구별할 수 있어요.',
                style: titleTextStyle,
              ),
            ),
            SizedBox(
